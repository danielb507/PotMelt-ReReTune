...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 1564.6852597985298; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -1499.7836728588059; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -1379.8160091724612; // x position of the perpendicular encoder (in tick units)
    }
